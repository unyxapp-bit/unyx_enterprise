...
const actionLabels: Record<string, string> = {
  ...
  operational_note_created: "Anotacao criada",
  operational_note_updated: "Anotacao atualizada",
  operational_note_deleted: "Anotacao excluida",
  operational_form_created: "Formulario criado",
